          ...
          <Table.Body>
            {fields.map((f, idx) => (
              <Table.Row key={idx}>
                ...
                <Table.Cell>
                  <Popup
                    trigger={<Button negative icon="delete" onClick={() => fields.remove(idx)} />}
...
let projectForm = (props) => {
  ...
  return (
    <Form onSubmit={handleSubmit} loading={submitting}>
      ...
      <Popup
        trigger={<Checkbox name="acceptsRawPayload" label="Accept payload archives" toggle />}
        content={
      ...
      <Message size="tiny" info>
        Not supported yet. Please use the REST API to update the configuration parameters.
      </Message>
