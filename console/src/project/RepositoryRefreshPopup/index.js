        ...
        return (
            <Modal open={open}>
                ...
                <Modal.Content>
                    <Modal.Description>
                        {refreshError ? (
                            ...
                            <p>
                                Refreshing the repository will update the Concord's cache and reload
                                the project's trigger definitions.
                            </p>
                        )}
                    </Modal.Description>
                </Modal.Content>
                <Modal.Actions>
                    ...
                    {!refreshResult && (
                        <Button color="green" loading={refreshing} onClick={refreshFn}>
                            Refresh
                        </Button>
                    )}
                </Modal.Actions>
