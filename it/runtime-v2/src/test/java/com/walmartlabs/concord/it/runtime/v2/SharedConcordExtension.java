...
/**
 * JUnit 5 extension that provides access to a shared Concord container environment.
 * <p>
 * Usage:
 * <pre>
 * {@code
 * @ExtendWith(SharedConcordExtension.class)
 * public class MyIT extends AbstractTest {
 *
 ...
 *         concord.processes().start(...);
 *     }
 * }
 * }
 * </pre>
 *
 * @see SharedConcordEnvironment
 */
