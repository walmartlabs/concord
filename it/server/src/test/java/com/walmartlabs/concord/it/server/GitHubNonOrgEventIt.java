...
public class GitHubNonOrgEventIt extends AbstractServerIT {
    ...
    public void test() throws Exception {
        ...
        while (true) {
            processes = processV2Api.listProcesses(null, orgName, null, projectName, null, null, null, null, null, ProcessEntry.StatusEnum.FINISHED.getValue(), null, null, null, null, null);
    ...
    private void githubEvent(String eventFile, String repoName, String eventName) throws Exception {
        ...
        String result = gitHubEvents.onEvent("abc", eventName, event);
