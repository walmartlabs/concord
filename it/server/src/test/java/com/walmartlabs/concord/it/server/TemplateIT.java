...
public class TemplateIT extends AbstractServerIT {
    ...
    public void test() throws Exception {
        ...
        projectResource.create(new CreateProjectRequest(projectName, new String[]{templateName}));
    ...
    private static Path createTemplate() throws IOException {
        ...
        Path metaPath = tmpDir.resolve(TemplateConstants.METADATA_TEMPLATE_FILENAME);
