...
public class ProjectFileIT extends AbstractServerIT {
    ...
    public void testArchiveOverride() throws Exception {
        ...
        projectResource.createOrUpdate(new ProjectEntry(projectName, Collections.singletonMap(repoName, new RepositoryEntry(null, null, repoName, repoUrl, "master", null, null, secretName, false, null))));
