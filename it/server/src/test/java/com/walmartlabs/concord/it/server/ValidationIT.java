...
public class ValidationIT extends AbstractServerIT {
    ...
    public void testProjectCreation() {
        ...
        try {
            ProjectEntry req = new ProjectEntry(null, "@123_123", null, null, null, null, null);
            projectResource.createOrUpdate(req);
            fail("Should fail with validation error");
        } catch (BadRequestException e) {
        }

        ProjectEntry req = new ProjectEntry(null, "aProperName@" + System.currentTimeMillis(), null, null, null, null, null);
        projectResource.createOrUpdate(req);
    }
