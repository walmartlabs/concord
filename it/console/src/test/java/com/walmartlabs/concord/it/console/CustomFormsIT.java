 ...
 */
public class CustomFormsIT extends AbstractConsoleIT {
    ...
    public void test() throws Exception {
        ...
        String gitUrl = createRepo("customForm");
        ...
        Map<String, Object> formFields = (Map<String, Object>) executeJavaScript("return data.definitions");
        ...
        WebElement submitButton = waitFor(By.id("submitButton"));
        submitButton.click();
