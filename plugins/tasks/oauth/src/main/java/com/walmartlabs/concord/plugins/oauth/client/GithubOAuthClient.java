...
public class GithubOAuthClient extends OAuthClient {
    ...
    public GithubOAuthClient(String concordBaseUrl, String authorityUrl) throws URISyntaxException {
    ...
    protected Map<String, String> getAuhorizationUrlParams(String clientId, String state, String scope) {
        return Map.of("client_id", clientId, "redirect_uri", redirectUrl, "scope", scope, "state", state);
    }
