...
public class SecretDaoTest extends AbstractDaoTest {
    ...
    public void testOnCascade() {
        ...
        UUID secretId = secretDao.insert(orgId, secretName, null, SecretType.KEY_PAIR, SecretEncryptedByType.SERVER_KEY, "concord", SecretVisibility.PUBLIC, INSERT, secretSalt, HashAlgorithm.SHA256);
