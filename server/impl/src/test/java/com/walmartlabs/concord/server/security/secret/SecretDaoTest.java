...
public class SecretDaoTest extends AbstractDaoTest {
    ...
    public void testOnCascade() {
        ...
        UUID projectId = projectDao.insert(orgId, projectName, "test", null, null, null, true, new byte[0], null);
        ...
        UUID repoId = repositoryDao.insert(projectId, repoName, "n/a", null, null, null, secretId, false);
