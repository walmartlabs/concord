...
public class NotificationModule implements Module {
    ...
    public void configure(Binder binder) {
        binder.bind(NotificationsDao.class).in(SINGLETON);
        binder.bind(CommunicationHistoryDao.class).in(SINGLETON);
        bindJaxRsResource(binder, NotificationResource.class);
    }
}
