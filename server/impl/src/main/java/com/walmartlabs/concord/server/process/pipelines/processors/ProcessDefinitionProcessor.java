...
import static com.walmartlabs.concord.process.loader.ProjectLoader.DEFAULT_RUNTIME_TYPE;
...
public class ProcessDefinitionProcessor implements PayloadProcessor {
    ...
    private static String getRuntimeType(Payload payload) throws IOException {
        ...
        Path workDir = payload.getHeader(Payload.WORKSPACE_DIR);
        return ProjectLoader.getRuntimeType(workDir, DEFAULT_RUNTIME_TYPE);
    }
