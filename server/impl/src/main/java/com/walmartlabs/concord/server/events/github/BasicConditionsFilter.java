...
@Named
public class BasicConditionsFilter implements ConditionsFilter {
    ...
    @Override
    public boolean filter(Payload payload, TriggerEntry trigger, Map<String, Object> conditions, Map<String, Object> event) {
