...
import com.walmartlabs.concord.server.api.agent.CommandQueueResource;
...
@Named
public class CommandQueueResourceImpl implements CommandQueueResource, Resource {

    private final AgentCommandsDao commandsDao;

    @Inject
    public CommandQueueResourceImpl(AgentCommandsDao commandsDao) {
        this.commandsDao = commandsDao;
    }

    @Override
    public CommandEntry take(String agentId) {
