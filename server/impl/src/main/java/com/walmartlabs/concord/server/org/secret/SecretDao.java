...
public class SecretDao extends AbstractDao {
    ...
    public UUID insert(UUID orgId, String name, UUID ownerId, SecretType type,
                       ...
                       byte[] secretSalt, HashAlgorithm hashAlgorithm) {

        return txResult(tx -> insert(tx, orgId, name, ownerId, type, encryptedBy, storeType, visibility, insertMode, secretSalt, hashAlgorithm));
    }
    ...
    private static SecretEntry toEntry(DSLContext tx, Record15<UUID, String, UUID, String, String, String, String, String, UUID, String, String, String, String, byte[], String> r) {
    ...
    public static class SecretDataEntry extends SecretEntry {
        ...
        public SecretDataEntry(UUID id, String name, UUID orgId, String orgName, UUID projectId, String projectName, Set<ProjectEntry> projects, SecretType type,
            ...
            super(id, name, orgId, orgName, projectId, projectName, projects, type, encryptedByType, storeType, visibility, owner, secretSalt, hashAlgorithm);
            this.data = data;
        }
