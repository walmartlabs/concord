...
public class JsonStoreManager {
    ...
    public UUID insert(String orgName, String storeName, JsonStoreVisibility visibility, EntityOwner entityOwner) {
        ...
        policyManager.checkEntity(org.getId(), null, EntityType.STORAGE, EntityAction.CREATE, owner, PolicyUtils.toMap(org.getId(), storeName, visibility, owner));
    ...
    public void update(String orgName, UUID storeId, JsonStoreRequest entry) {
        ...
        policyManager.checkEntity(org.getId(), null, EntityType.STORAGE, EntityAction.UPDATE, owner, PolicyUtils.toMap(org.getId(), prevStoreName, entry.visibility(), owner));
