...
//    @ApiOperation(value = "List user api keys", responseContainer = "list", response = ApiKeyEntry.class)
    ...
    @Validate
    public List<ApiKeyEntry> list(@Parameter @QueryParam("userId") UUID requestUserId) {
...
//    @ApiOperation("Create a new API key")
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Validate
    public CreateApiKeyResponse create(@Parameter @Valid CreateApiKeyRequest req) {
...
//    @ApiOperation("Delete an existing API key")
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Validate
    public GenericOperationResult deleteKeyById(@Parameter @PathParam("id") UUID id) {
