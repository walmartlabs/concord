...
import com.walmartlabs.concord.server.api.agent.TCommandQueueGrpc.TCommandQueueBlockingStub;
...
public class CommandQueueImpl implements CommandQueue {
    ...
    public Command take() throws ClientException {
        TCommandQueueBlockingStub blockingStub = TCommandQueueGrpc.newBlockingStub(channel);
        while (true) {
