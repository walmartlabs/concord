 ...
 */
public class IntermediateGlobalsContext implements Context {

    private final Context delegate;
    private final GlobalVariables globalVariables;

    public IntermediateGlobalsContext(Context delegate, GlobalVariables overrides) {
        this.delegate = delegate;
        this.globalVariables = overrides;
    }
