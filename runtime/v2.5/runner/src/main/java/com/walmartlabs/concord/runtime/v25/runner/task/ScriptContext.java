...
final class ScriptContext implements Context {

    private final Context delegate;
    private final Variables variables;

    ScriptContext(Context delegate) {
    ...
    public <T> T eval(Object value, Class<T> expectedType) {
        return delegate.eval(value, expectedType);
    }

    @Override
    public <T> T eval(Object value, Map<String, Object> overrides, Class<T> expectedType) {
        return delegate.eval(value, overrides, expectedType);
    }
