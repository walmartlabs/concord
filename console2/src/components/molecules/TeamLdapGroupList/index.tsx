...
import { FindLdapGroupField } from '../../organisms';
...
interface Props {
    ...
    submitting: boolean;
    submit: (users: NewTeamLdapGroupEntry[]) => void;
}

const toState = (data: TeamLdapGroupEntry[]): Entry[] =>
...
class EntryList extends React.Component<Props, State> {
    ...
    handleAdd(ldapGroup: LdapGroupSearchResult) {
        const { data } = this.state;
        const e = {
